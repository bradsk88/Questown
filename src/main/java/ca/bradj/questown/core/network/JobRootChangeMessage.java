...
public record JobRootChangeMessage(BlockPos flagPos, UUID villagerUUID, JobID id) {
    ...
    public static JobRootChangeMessage decode(FriendlyByteBuf buffer) {
        ...
        return new JobRootChangeMessage(flagPos, uuid, jobId);
    }
    ...
    public void handle(
        ...
        ctx.get().enqueueWork(() -> {
            ...
            flag.get().getVillagerHandle().scheduleJobRootChange(villagerUUID);
        });
