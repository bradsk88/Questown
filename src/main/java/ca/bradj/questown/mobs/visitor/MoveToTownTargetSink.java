...
public class MoveToTownTargetSink extends Behavior<Mob> {
    ...
    protected boolean canStillUse(ServerLevel p_23586_, Mob p_23587_, long p_23588_) {
        if (this.path != null && this.lastTargetPos != null) {
            ...
            return !pathnavigation.isDone() && optional.isPresent() && !this.reachedTarget(p_23587_, (WalkTarget)optional.get());
        } else {
            return false;
        }
    }
    ...
    private boolean tryComputePath(Mob p_23593_, WalkTarget p_23594_, long p_23595_) {
        ...
        if (this.reachedTarget(p_23593_, p_23594_)) {
            ...
            Vec3 vec3 = DefaultRandomPos.getPosTowards((PathfinderMob)p_23593_, 10, 7, Vec3.atBottomCenterOf(blockpos), 1.5707963705062866);
            if (vec3 != null) {
