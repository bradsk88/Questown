...
@OnlyIn(Dist.CLIENT)
public class VisitorArrowLayer extends VisitorStuckInBodyLayer {
    private final EntityRenderDispatcher dispatcher;

    public VisitorArrowLayer(EntityRendererProvider.Context p_174465_, VisitorMobRenderer p_174466_) {
        super(p_174466_);
        this.dispatcher = p_174465_.getEntityRenderDispatcher();
    }

    protected int numStuck(VisitorMobEntity p_116567_) {
