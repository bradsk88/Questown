...
public class SetWalkTargetFromBlockMemory extends Behavior<VisitorMobEntity> {
    ...
    public SetWalkTargetFromBlockMemory(
            MemoryModuleType<GlobalPos> p_24046_,
            float p_24047_,
            int p_24048_,
            int p_24049_,
            int p_24050_
    ...
    private void dropPOI(
            VisitorMobEntity p_24076_,
            long p_24077_
    ) {
    ...
    private boolean tiredOfTryingToFindTarget(
            ServerLevel p_24056_,
            VisitorMobEntity p_24057_
    ) {
    ...
    private boolean closeEnough(
            ServerLevel p_24069_,
            VisitorMobEntity p_24070_,
            GlobalPos p_24071_
    ) {
        return p_24071_.dimension() == p_24069_.dimension() && p_24071_.pos()
                .distManhattan(p_24070_.blockPosition()) <= this.closeEnoughDist;
    }
}