...
public class SetJobCommand {
    public static void register(CommandDispatcher<CommandSourceStack> p_137808_, CommandBuildContext ctx) {
        p_137808_.register(Commands.literal("qtsetjob")
                .requires((p_137812_) -> {
                    return p_137812_.hasPermission(2);
                })
                .then(Commands.argument("targets", EntityArgument.entities())
                        .then(Commands.argument("job_id", JobArgument.job(ctx)).executes(css -> {
