...
public class GathererUnmappedPickaxeWorkHalfDay extends NewLeaverWork {
    ...
    public static final JobID ID = new JobID("gatherer", "pickaxe_half_day");
    ...
    public GathererUnmappedPickaxeWorkHalfDay() {
        super(PARAMS);
    }
    ...
    public static Work asWork() {
        return NewLeaverWork.asWork(
                ...
                SPECIAL_RULES,
                GathererUnmappedPickaxeWorkHalfDay::getFromLootTables
        );
    }
