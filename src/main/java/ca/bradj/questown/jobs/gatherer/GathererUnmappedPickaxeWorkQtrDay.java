...
public class GathererUnmappedPickaxeWorkQtrDay extends NewLeaverWork {
    ...
    public GathererUnmappedPickaxeWorkQtrDay() {
        super(PARAMS);
    }
    ...
    public static Work asWork() {
        return NewLeaverWork.asWork(
                ...
                SPECIAL_RULES,
                GathererUnmappedPickaxeWorkQtrDay::getFromLootTables
        );
    }
