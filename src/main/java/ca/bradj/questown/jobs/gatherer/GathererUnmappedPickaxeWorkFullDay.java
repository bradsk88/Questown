...
public class GathererUnmappedPickaxeWorkFullDay extends NewLeaverWork {
    ...
    public static final JobID ID = new JobID("gatherer", "pickaxe_full_day");
    ...
    public GathererUnmappedPickaxeWorkFullDay() {
        super(PARAMS);
    }
    ...
    public static Work asWork() {
        return NewLeaverWork.asWork(
                ID,
                GathererUnmappedPickaxeWorkHalfDay.ID,
                ...
                SPECIAL_RULES,
                GathererUnmappedPickaxeWorkFullDay::getFromLootTables
        );
    }
