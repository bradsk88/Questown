...
//    }
    ...
    Function<WorkLocation, ImmutableList<RoomRecipeMatch<MCRoom>>> roomsMatching(
            TownInterface town
    ) {
        return loc -> ImmutableList.copyOf(town.getRoomHandle().getRoomsMatching(loc.baseRoom()));
    }
    ...
    Supplier<Claim> getClaimSupplier() {
