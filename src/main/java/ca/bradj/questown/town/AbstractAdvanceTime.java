...
public abstract class AbstractAdvanceTime<
     ...
     * This matches TownFlagState.Work but is declared here to avoid Minecraft dependencies.
     */
    ...
    public Result<TOWN> advanceTime(
        ...
        ImportantTicks.Config cfg = new ImportantTicks.Config(downtimeTicks);
    ...
    /**
     * Adapts our Work interface to TownFlagState.Work for use with ImportantTicks.
     * Subclasses can override this if they need custom adaptation.
     */
    protected ca.bradj.questown.town.entity.TownFlagState.Work adaptWork(Work work) {
        return new ca.bradj.questown.town.entity.TownFlagState.Work() {
            @Override
            ...
            public @Nullable JobID getRandomFinishableWork(
                ...
                return work.getRandomFinishableWork(jobID, dayTime, ticksElapsed);
            }

            @Override
            public long getTotalDuration(JobID jobID, VillagerUUID vuid) {
                return work.getTotalDuration(jobID, vuid);
            }

            @Override
            public int getWarpTicksPerCycle(JobID jobID, VillagerUUID vuid) {
                return work.getWarpTicksPerCycle(jobID, vuid);
            }
        };
    }
