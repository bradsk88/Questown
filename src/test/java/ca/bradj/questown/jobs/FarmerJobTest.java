...
class FarmerJobTest {
    ...
    public void test_FarmWithDirtAndTilledAndCompost_ShouldPlant_Order1() {
        @Nullable WorkSpot ws = FarmerJob.getWorkSpot(
                ImmutableList.of(
                        new WorkSpot<>(new Position(0, 0), FarmerJob.FarmerAction.COMPOST, 0),
                        new WorkSpot<>(new Position(1, 1), FarmerJob.FarmerAction.TILL, 0),
                        new WorkSpot<>(new Position(2, 2), FarmerJob.FarmerAction.PLANT, 0)
                ),
